...
export default function Register() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      ...
      <h1 className="text-3xl text-white font-bold mb-4 text-center rounded-lg"> Register </h1>
    </div>
      <div>
      <h1 className="text-3xl text-white font-bold mb-4 text-center"> Register to join</h1>
